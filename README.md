...
emailUsername = username for your mailaccount | test@yourdomain.de
emailPassword = password for your mailaccount | x!§$!shj123
emailReadFolderPath = folder which should be read out | cfp/inbox
...
jiraPassword = password for your jiraaccount | x!§$!shj123
